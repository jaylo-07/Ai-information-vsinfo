...
const Career = () => {
  ...
  return (
    <div className='overflow-hidden'>
      <section className="bg-white dark:bg-black text-black dark:text-white transition-colors duration-300" data-aos="zoom-in" data-aos-duration="3000">
      ...
      <section className="bg-white dark:bg-black text-black dark:text-white container mx-auto sm:!px-6 !px-4 py-12 transition-colors duration-300">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1" data-aos="zoom-in" data-aos-duration="3000">
            ...
            <p className="mb-6 text-gray-700 dark:text-gray-300">We create a welcoming atmostphere that inspire uniqueness, originality and personal identity. By providing flexible work time-table and continuos support for there proffessional growth, We try to give our employees get success in an fronts.</p>
            ...
            <div className="relative w-full h-full flex items-center justify-center" style={{ transformStyle: 'preserve-3d' }}>
              {slides.map((slide, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`absolute sm:w-80 sm:h-80 w-60 h-60 cursor-pointer transition-all duration-1000 ease-out ${isActive ? 'hover:scale-105' : 'hover:scale-110'
                      }`}
                    style={{
                      ...style3D,
      ...
      <section className="bg-gray-100 dark:bg-black text-black dark:text-white transition-colors duration-300">
        <div className="container mx-auto py-12 sm:!px-6 !px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex flex-col justify-between border border-gray-300 dark:border-gray-700 rounded-2xl p-6 w-full md:w-[300px] transform transition duration-500 hover:scale-105 hover:shadow-2xl bg-white dark:bg-transparent"
              style={{ boxShadow: "0 8px 25px rgba(0,0,0,0.4)" }} data-aos="flip-left" data-aos-duration="3000">
              <h3 className="text-xl font-semibold mb-2">Frontend Developer</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">Remote • Full-time</p>
              <p className="mb-6 text-gray-700 dark:text-gray-300">Use modern web technologies to create responsive, user-focused interfaces.</p>
              <a href="#" className="inline-block px-4 py-2 border border-black dark:border-gray-500 hover:bg-black hover:text-white dark:hover:bg-gray-500 dark:hover:text-white rounded-lg transition text-center">Apply Now</a>
            </div>

            <div className="flex flex-col justify-between border border-gray-300 dark:border-gray-700 rounded-2xl p-6 w-full md:w-[300px] transform transition duration-500 hover:scale-105 hover:shadow-2xl bg-white dark:bg-transparent"
              style={{ boxShadow: "0 8px 25px rgba(0,0,0,0.4)" }} data-aos="flip-left" data-aos-duration="3000">
              <h3 className="text-xl font-semibold mb-2">UI/UX Designer</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">New York, NY • Hybrid</p>
              <p className="mb-6 text-gray-700 dark:text-gray-300">Craft visually appealing and easy-to-use product experiences.</p>
              <a href="#" className="inline-block px-4 py-2 border border-black dark:border-gray-500 hover:bg-black hover:text-white dark:hover:bg-gray-500 dark:hover:text-white rounded-lg transition text-center">Apply Now</a>
            </div>
            ...
            <div className="flex flex-col justify-between border border-gray-300 dark:border-gray-700 rounded-2xl p-6 w-full md:w-[300px] transform transition duration-500 hover:scale-105 hover:shadow-2xl bg-white dark:bg-transparent"
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">Remote • Full-time</p>
              <p className="mb-6 text-gray-700 dark:text-gray-300">Develop robust APIs with a focus on scalability, speed, and security.</p>
              <a href="#" className="inline-block px-4 py-2 border border-black dark:border-gray-500 hover:bg-black hover:text-white dark:hover:bg-gray-500 dark:hover:text-white rounded-lg transition text-center">Apply Now</a>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto sm:!px-6 !px-4 py-12">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 text-black dark:text-white">
          <div className='w-full' data-aos="zoom-in" data-aos-duration="3000">
            <p className="tracking-widest text-sm text-gray-700 dark:text-gray-300">[ OUR PRINCIPLES ]</p>
            <h1 className="text-3xl md:text-[40px] font-semibold mt-2"> <span className='text-themedark'>Coding</span> ≥ ∀ x ∀ x</h1>
          </div>
          <p className="md:max-w-lg w-full text-gray-700 dark:text-gray-300" data-aos="zoom-in" data-aos-duration="3000">We thrive on ambitious goals, quick decisions, and an unwavering will to get things done quickly. We'd love to have you on board if you're excited to contribute to the development of AI models and products in the future.</p>
        </div>

        <div className="grid md:grid-cols-3 gx-8 mt-16 pt-2 sm:pt-12">
          {/* <div className="flex flex-col gap-12  "> */}
          <div data-aos="zoom-in" data-aos-duration="3000" className='md:border-r  text-black dark:text-white border-gray-300 dark:border-gray-800 pr-8 p-4'>
            <div className="text-2xl mb-7"><FaRegUser className='text-3xl' /></div>
            <h3 className="font-semibold text-lg mb-4">Appealing Salary</h3>
            <p className="text-gray-600 dark:text-gray-400 text-md mt-1">In order to draw in and keep the top individuals in the business, we provide attractive stock and compensation packages.</p>
          </div>
          <div data-aos="zoom-in" data-aos-duration="3000" className='md:border-r  text-black dark:text-white border-gray-300 dark:border-gray-800 pr-8  p-4'>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-md mt-1">	We support a good work-life balance. We don't want burnout, so take the time you need to rest.</p>
          </div>
          {/* </div> */}

          {/* <div className="flex flex-col gap-12 md:border-r text-black dark:text-white border-gray-800 pr-8"> */}
          <div data-aos="zoom-in" data-aos-duration="3000" className='p-4 text-black dark:text-white'>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-md mt-1">To promote your general well-being, we offer comprehensive health coverage, including dental, vision, medical, and disability insurance.</p>
          </div>
          <div data-aos="zoom-in" data-aos-duration="3000" className='md:border-r  text-black dark:text-white border-gray-300 dark:border-gray-800 pr-8 p-4'>
            <div className="text-2xl mb-7"><TbWorld className='text-3xl' /></div>
            <h3 className="font-semibold text-lg mb-4">Visa Support</h3>
            <p className="text-gray-600 dark:text-gray-400 text-md mt-1">Visa Support To help you join our team, we welcome talent from around the world and provide visa sponsorship.</p>
          </div>
          {/* </div> */}
          ...
          <div data-aos="zoom-in" data-aos-duration="3000" className='md:border-r  text-black dark:text-white border-gray-300 dark:border-gray-800 pr-8 p-4'>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-md mt-1">Our benefits, which provide you and your loved ones with peace of mind, include fertility support, life and AD&D insurance, and more.</p>
          </div>
          <div data-aos="zoom-in" data-aos-duration="3000" className='text-black dark:text-white p-4' >
            ...
            <p className="text-gray-600 dark:text-gray-400 text-md mt-1">Our 401(k) plan assists you in getting ready for a healthy and safe financial future.</p>
          </div>
          {/* </div> */}
        </div>
      </section>
