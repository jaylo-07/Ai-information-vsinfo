        ...
        <div className=''>
          <div className='container mx-auto py-12 sm:!px-6 !px-4'>
            <div className="flex justify-center" data-aos="zoom-in" data-aos-duration="3000">
              <div className="3xl:w-1/3 lg:w-1/2  text-black dark:text-white">
                ...
                <p className='text-center mt-4 sm:text-[16px] text-[14px] text-gray-700 dark:text-[#f0f0f0]'>Our work inspires awe and connection that transcends technology. We're pushing the envelope and influencing how AI affects the metaverse with our Llama open-source language models, state-of-the-art virtual reality equipment, and Ray-Ban Meta smart glasses.</p>
              </div>
            </div>
                      ...
                      {accordionData.map((item, index) => {
                        ...
                        return (
                          <div key={index} data-aos="fade-right" data-aos-duration="3000">
                            {/* Header */}
                            <button onClick={() => toggle(index)} className="flex w-full my-8 justify-between text-black dark:text-white sm:text-[20px] text-[18px] items-center text-left font-semibold text-lg focus:outline-none">
                              {item.title}
                              {isOpen ? (
