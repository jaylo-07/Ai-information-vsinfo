          ...
          <div className='flex gap-4 lg:flex-nowrap flex-wrap rounded-[30px] overflow-hidden 2xl:mx-10 mx-5'>
            <div className="lg:w-1/2 w-full relative overflow-hidden" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
              ...
              <div className={`transition-opacity duration-700 ease-in-out ${hovered ? "opacity-0 cursor-pointer" : "opacity-100"}`}>
                <JigsawPuzzle imageSrc={team} rows={3} columns={3} onSolved={() => toast.success("Puzzle solved!")} className="h-full object-cover" />
              </div>
            </div>
            <div className='lg:w-1/2 w-full bg-gray-100 dark:bg-[#222222] lg:mt-0  mt-5'>
              <div className='sm:p-[65px] sx:p-[35px] p-[20px] text-black dark:text-white'>
                <p data-aos="fade-left">Mentorship programs</p>
                <h3 className="text-black dark:text-white text-[22px] sm:text-[32px] md:text-[40px] lg:text-[40px] sm:leading-[46px] leading-[28px] mt-4 md:block hidden" data-aos="fade-left" >Get hands-on experience with <span className='text-themedark'>AI</span> <br></br> research</h3>
                <h3 className="text-black dark:text-white text-[22px] sm:text-[32px] md:text-[40px] lg:text-[40px] sm:leading-[46px] leading-[28px] mt-4 md:hidden block" data-aos="fade-left" >Get hands-on experience with <span className='text-themedark'>AI</span> <br></br> research</h3>
