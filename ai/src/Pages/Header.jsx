            ...
            {user ? (
              ...
              <div className="origin-right ">
                ...
                <button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 p-[1px] rounded-full bg-primary-dark/20 text-white border-2 border-gray-600/50 w-full hover:bg-gray-700/60 transition-all duration-300 hover:border-gray-500/50 backdrop-blur-sm"
                >
                  <div className='w-9 h-9 p-1 rounded-full'>
