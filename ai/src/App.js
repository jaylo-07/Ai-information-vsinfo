...
import { Mic, Plus, SlidersHorizontal, ChevronDown, Search, Image as ImageIcon, LayoutPanelTop, GraduationCap, Upload, FolderOpen, Images, File as FileIcon, X } from 'lucide-react';
                ...
                <div className="flex items-center justify-between text-xs md:text-sm text-gray-600 dark:text-[#c4c7c5]">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center w-8 h-8 md:w-9 md:h-9 rounded-full transition-colors ${isListening
